...
# Количество ходов
Для заданного начального состояния алгоритм A* с эвристикой Манхэттена гарантированно находит оптимальное (минимальное) число ходов. 
Вот как это работает:
- Вход: вектор из 16 чисел (перестановка чисел от 0 до 15), где 0 — пустая клетка.
- Выход: целое число — минимальное количество перемещений пустой клетки, необходимое для сборки головоломки. Если решение невозможно, возвращается −1.

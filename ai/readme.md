# Нейронная сеть для определения качества пищи по химическим показателям
# Подготовили студенты группы 15.27Д-ПИ01/25б Галкина Елизавета и Железная Анастасия
